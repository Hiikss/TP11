...
//Il est possible de créer des tableaux d'objets
var sports = [sport, sport2, { nom: "PADEL", description: "un autre jeu de raquetes" }];
sports.push({ nom: "TENNIS", description: "ça claque" })
console.log(sports)

//Un objet peut référencer un tableau
sport.qualificatifs = ["Rapide", "Fatiguant", "..."]
console.log(sport)